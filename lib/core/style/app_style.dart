...
class AppStyle {
  ...
  static TextStyle textStyle15GreenW500 = TextStyle(
      color: AppColors.green, fontWeight: FontWeight.w500, fontSize: 14.w);
  static TextStyle textStyle14GreenW400 = TextStyle(
  ...
  static TextStyle textStyle16PrimaryW400 = TextStyle(
      color: AppColors.primary, fontWeight: FontWeight.w400, fontSize: 16.w);

  static TextStyle textStyle12GrayW400 = TextStyle(
      color: AppColors.textGray, fontWeight: FontWeight.w400, fontSize: 12.w);
  static TextStyle textStyle12GrayLightW400 = TextStyle(
      color: AppColors.iconHomeColor,
      fontWeight: FontWeight.w400,
      fontSize: 12.w);
  static TextStyle textStyle12PinkW400 = TextStyle(
      color: AppColors.dotColor, fontWeight: FontWeight.w400, fontSize: 12.w);
