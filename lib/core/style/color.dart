...
class AppColors{
  ...
  static const Color bgContainerColor =   Color(0xff2F3C50);
  static const Color border1ContainerColor =   Color(0xff535E6E);
  static const Color border2ContainerColor =   Color(0xff2B3744);
  static const Color shadowContainerColor =   Color(0xff1C252C0D);
  static const Color storeContainerBrand =   Color(0xff2F3C5066);
  ...
  static const Color storeCard1 =   Color(0xffFF3A51);
  static const Color storeCard2 =   Color(0xffF45C43);
